...
class ContractFactory extends Factory
{
    ...
    public function definition(): array
    {
        return [
            ...
            'contact_id' => ::factory(),
            'contract_amount' => fake()->randomFloat(4, 0, 999999999999.9999),
            'contract_tax_rate' => fake()->randomFloat(4, 0, 999999999999.9999),
            'contract_amount_wtax' => fake()->randomFloat(4, 0, 999999999999.9999),
